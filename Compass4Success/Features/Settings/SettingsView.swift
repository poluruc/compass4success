...
struct AppearanceSettingsView: View {
    ...
    @AppStorage("interfaceStyle") private var interfaceStyle = "Default"
    @State private var selectedColor = Color.blue
    
    // Available theme options
    private let themes = ["Default", "Light", "Dark", "System"]
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                ...
                GroupBox(label: Label("Interface Theme", systemImage: "paintpalette")) {
                    Picker("Select Theme", selection: $interfaceStyle) {
                ...
                GroupBox(label: Label("Accent Color", systemImage: "circle.fill").foregroundColor(selectedColor)) {
                            ...
                            ForEach(predefinedColors, id: \.self) { color in
                                Circle()
                                    ...
                                    .onTapGesture {
                                        ...
                                        accentColorHex = color.toHex() ?? "#007AFF"
                                    }
                            }
                        }
                        .padding(.vertical, 10)
